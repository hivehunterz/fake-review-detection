...
class GoogleReviewsLabeler:
    ...
    def __init__(self):
        ...
        # Define LLM providers with fast switching configuration
        self.providers = [
            LLMProvider(
                name="OpenAI GPT-4",
                ...
                model="gpt-4",  # Full GPT-4 for maximum accuracy
                max_tokens=1500,
                rate_limit_delay=2.0,  # More conservative rate limiting
                max_retries=1  # Reduced for faster switching
            ),
            LLMProvider(
                name="OpenAI GPT-4-Turbo",
                api_key=os.getenv('OPENAI_API_KEY', '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'),
                base_url="https://api.openai.com/v1/chat/completions",
                model="gpt-4-turbo",  # GPT-4 Turbo as backup
                max_tokens=1500,
